...
public partial class Fall24PharmaceuticalDbContext : DbContext
{
    ...
    //protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=(local);Uid=sa;Pwd=12345678;Database=Fall24PharmaceuticalDB;TrustServerCertificate=True");
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ManufacturerId).HasName("PK__Manufact__357E5CA1255CB3C7");
        ...
        {
            entity.HasKey(e => e.MedicineId).HasName("PK__Medicine__4F2128F001023D44");
        ...
        {
            entity.HasKey(e => e.StoreAccountId).HasName("PK__StoreAcc__42D52A6A94813924");

            entity.ToTable("StoreAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__StoreAcc__49A14740DA8BAD23").IsUnique();
